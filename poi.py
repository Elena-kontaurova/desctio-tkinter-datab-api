...
class EmployeeCard:
    def __init__(self, master, employee_data):
        ...
        self.card_frame = tk.Frame(self.master, relief='sunken', borderwidth=2, pady=10, padx=10, bg='#D1FFA8', width=300, height=150)
    ...
    def display_employee_info(self):
        ...
        label_name = f"{fcs}"
        label_contact = f"{work_phone} | {cor_email}"
        label_office = f"Кабинет: {office}"

        # Устанавливаем метки для отображения информации
        title_label = tk.Label(self.card_frame, text=label_title, bg='#D1FFA8', anchor='w', font=("Arial", 10, 'bold'))
